...
1. Creați un repositoriu privat ``examen-web2-2023-ff`` și deschideți acces pentru ``sergiuchilat`` **(1p)**
...
2. Bus: number, color, maxPlaces [Biscupscaia Stanislava ]
3. Rabbit: name, age, type  [Savca-Mocanu Ana]
4. Train: routeName, maxPassengers, color [Prian Vladislav]
5. Employee: idnp, name, salary
6. PC: brand, ramSize, price [Cibotari Sandu]
7. Phone: brand, color, price [Braiu Ilie]
8. Bank Account: number, totalMoney, ownerName
9. Student: name, group, averageMark [Popovici Tudor]
10. Company: name, website, totalEmployees [Soha Igor]
11. Store: name, address, totalProducts
12. Monitor(screen): brand, resolution [Bajerean Ion]
13. Teacher: name, school, experience(in years)
14. Fish: species, weight, age(years)
15. POS terminal: number, storeName, casInForDay
16. Pupil: name, class, averageMark [Mocanu Sergiu]
17. User: email, password, phone [Donțu Constantin]
18. Product: name, price, weight [Pelenciuc Igor]
19. Butterfly: type, color, age(in days) [Murzac Sergiu]
